                ...
                <div className='FooterListStyle'>
                    <ul style={{listStyle: 'none', width:'25vh'}}>
                        <li>
                            ...
                            <a href="https://www.linkedin.com/in/lucas-camino-0808231b6/" style={{textDecoration: 'none', color:'black'}}>Linkedin</a>
                        </li>
                        <li>
                    ...
                    <ul style={{listStyle: 'none', width:'25vh'}}>
                        <li>
                            ...
                            <a href="https://www.instagram.com/lucas_camino15/" style={{textDecoration: 'none', color:'black'}}>Instagram</a>
                        </li>
                        <li>
                            ...
                            <a href="https://www.instagram.com/lucas_camino15/" style={{textDecoration: 'none', color:'black'}}>Contacto</a>
                        </li>
                    </ul>
                </div>
            </div>
